...
ShrubberyCreationForm::ShrubberyCreationForm() : Form("defaultShrubberyCreationForm", 145, 137), _target("default target")
{}

ShrubberyCreationForm::ShrubberyCreationForm(std::string const & target) : Form("ShrubberyCreationForm " + target, 145, 137), _target(target)
{
